    ...
    function loadExamResults() {
        ...
        function loadRegistrationPage() {
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    alert('Error loading registration page: ' + error);
                }
            });
        }
...
<body>
    <!--//Hidden session stuffs-->
    <input style="display:none; margin-left: 100px;" id="adminKeyword" value="${sessionScope.fullName}">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li style="display:none;" id="adminKey"><a href="#" onclick="loadRegistrationPage()"><i class="fas fa-add"></i><span class="text">Register</span></a></li>   
            <script>
    var adminKeyword = document.getElementById('adminKeyword');
    var adminKey = document.getElementById('adminKey');

    // Function to check and toggle the adminKey visibility based on input value
    function toggleAdminKey() {
        if (adminKeyword.value === 'Admin') {
            adminKey.style.display = 'block';  // Show the hidden element
        } else {
            adminKey.style.display = 'none';   // Hide it
        }
    }

    // Check the value when the page loads
    window.onload = function() {
        toggleAdminKey();  // Initial check when the page loads
    };

    // Listen for input changes
    adminKeyword.addEventListener('input', toggleAdminKey);
</script>
...
<!--            <div class="form-group">
                <label for="timerValue">Timer Value (in minutes):</label>               "IDEA SCRAPPED"
